...
### 2. Here is the content of my git config file(~/.ssh/config):
```
...
### 3. The following is part of git config in my repository 
```
[remote "origin"]
...
### 4. Finally, there will be no errors with 'git push'
